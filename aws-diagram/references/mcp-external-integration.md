...
Generalized from real customer architecture work.
...
```json
{
  ...
  "nodes": [
    ...
    {"id": "sys1", "service": "on-premises", "label": "Demand Forecast", "sublabel": "On-Premises", "x": 4, "y": 1, "container": "customer"},
    {"id": "sys2", "service": "on-premises", "label": "Product Planning", "sublabel": "On-Premises", "x": 4, "y": 3, "container": "customer"}
  ],
  "connections": [
  ...
  "containers": [
    ...
    {"id": "customer", "type": "generic", "label": "Customer On-Premises Systems", "children": ["sys1", "sys2"]}
  ]
}
```
...
- `container: "customer"` groups the external systems in a generic container that
